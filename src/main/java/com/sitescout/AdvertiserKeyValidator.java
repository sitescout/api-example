...
/**
 * Validates the user input for advertiser ID.
 */
@FacesValidator("com.sitescout.AdvertiserKeyValidator")
public class AdvertiserKeyValidator implements Validator{
    ...
    public void validate(FacesContext context, UIComponent component,
        ...
        String url = "https://api.sitescout.com/advertisers/" + value + "/balance";
        ...
        try {
            ...
            if (errorCode.equals("SE00004")) {
                msg = new FacesMessage("Advertiser ID does not exist.");
            } else {
                msg =  new FacesMessage("You have no access to that Advertiser ID");
            }
