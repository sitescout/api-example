...
@Named
@ViewScoped
public class CampaignDetailsOfferStats extends APIStatsEntity {

    public StatsListDTO<EntityStatsDTO<OfferDTO>, StatsDTO> getDetails(int advertiserKey, int campaignKey) throws IOException {
